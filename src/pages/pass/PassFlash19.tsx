...
type HomeProps = {
  navigation: NavigationProp<RouteType, 'Pass_flash_19'>;
  route: RouteProp<RouteType, 'Pass_flash_19'>;
};
export const PassFlash19: React.FC<HomeProps> = ({navigation}) => {
          ...
          <View style={{height: 660}}>
            <View
              ...
              <Text
                ...
                {viewFlash ? '24,99€ /mois' : '19,99€ /mois'}
                <Text
                  style={{
                    fontSize: 32,
                    fontFamily: 'Gilory',
