...
type HomeProps = {
  navigation: NavigationProp<RouteType, 'TalkPhoneAccept'>;
  imagePath: string;
};
export const TalkPhoneAccept: React.FC<HomeProps> = ({
  navigation,
  imagePath,
}) => {
        ...
        <View style={{top: 50, width: 390, height: 34}}>
          ...
          <View
            ...
            <TouchableOpacity
              style={{height: 75, width: 75}}
              onPress={() =>
                navigation.navigate('TalkNavigator', {
                  TalkRoute: 'TalkPhoneAccept',
                })
              }>
              <Image
                style={{top: 0, alignSelf: 'center', width: 75, height: 75}}
