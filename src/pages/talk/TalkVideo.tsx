...
type HomeProps = {
  navigation: NavigationProp<RouteType, 'TalkVideo'>;
  imagePath: string;
};
export const TalkVideo: React.FC<HomeProps> = ({navigation, imagePath}) => {
  ...
  const [showTalkVideoAccept, setShowTalkVideoAccept] =
  ...
  return (
    <View style={{backgroundColor: '#fff', height: '100%', width: 'auto'}}>
      ...
      <ImageBackground
        resizeMode="contain"
        source={require('../../../assets/images/bg-video-call.png')}
        style={{height: '100%'}}>
        <View
          style={{
            top: 20,
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('TalkVideo')}>
            <Image
              style={{top: 0, alignSelf: 'center', width: 40, height: 40}}
              source={require('../../../assets/boutons/appel-video-blanc.png')}
            />
          </TouchableOpacity>
        </View>
        <View
