...
type HomeProps = {
  navigation: NavigationProp<RouteType, 'Niveau_etude'>;
  route: RouteProp<RouteType, 'Niveau_etude'>;
};

export const NiveauEtudeResearch: React.FC<HomeProps> = ({navigation}) => {
  useEffect(() => {
  ...
  const [selectedEtude, setSelectedEtude] = useState<string | null>(null);

  const handleEtudeToggle = (etude: string) => {
