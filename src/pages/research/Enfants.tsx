...
type HomeProps = {
  navigation: NavigationProp<RouteType, 'Enfants'>;
  route: RouteProp<RouteType, 'Enfants'>;
};

export const Enfants: React.FC<HomeProps> = ({navigation}) => {
  useEffect(() => {
  ...
  const handleEnfantToggle = (enfant: string) => {
