...
type HomeProps = {
  navigation: NavigationProp<RouteType, 'Revenus'>;
  route: RouteProp<RouteType, 'Revenus'>;
};

export const Revenus: React.FC<HomeProps> = ({navigation}) => {
  useEffect(() => {
  ...
  const [selectedRevenu, setSelectedRevenu] = useState<string | null>(null);

  const handleRevenuToggle = (revenu: string) => {
